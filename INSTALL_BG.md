...
```text
GROQ_API_KEY=сложи_твоя_groq_api_ключ_тук
```
...
Това приложение не трябва да се качва като чист GitHub Pages сайт, ако ще ползва AI API ключ.
