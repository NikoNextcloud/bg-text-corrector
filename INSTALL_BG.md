...
## Настройване на OpenAI ключ

1. Копирай файла `.env.example`.
2. Преименувай копието на `.env`.
3. Вътре замени:

```text
OPENAI_API_KEY=сложи_твоя_openai_api_ключ_тук
```
...
Това приложение не трябва да се качва като чист GitHub Pages сайт, ако ще ползва OpenAI API ключ.
